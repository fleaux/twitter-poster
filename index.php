...
// Check if you are connected to twitter through OAuth2.
if(isset($_SESSION['name']))	
{
	echo "<div style='width:650px;text-align:center;margin-bottom:20px;padding-top:20px;'>";
	echo "<u><b>TWITTER</u>:</b><br/><br/><a href='twitter_scripts/logout.php'>";
	echo "<img src='img/twitter_logout.png'></img></a></div>";
	?>
	...
	function open_win(){
		...
		// open a popup box to visualise your tweet and confirm the data sendings.
	...
	// change the tweet max lenght if you upload an image.
	if ( imagelength === 0)
	{
		var tweet = "140";
	}
...
// Display a login button to connect to twitter through OAuth2
else 
{
